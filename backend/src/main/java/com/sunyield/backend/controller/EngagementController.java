...
public class EngagementController {
    ...
    public ResponseEntity<?> reinvest(@RequestBody Map<String, Object> request) {
        try {
            ...
            String emailBody = String.format(
                ...
                "- Amount: ₹%s\n" +
                "- Date: %s\n\n" +
                "Your reinvestment will help expand solar energy generation and increase your future Energy Rewards.\n\n" +
    ...
    public ResponseEntity<?> gift(@RequestBody Map<String, Object> request) {
        try {
            ...
            String recipientEmailSubject = "Gift Received - SunYield";
        ...
        try {
            ...
            for (CreditTransferLog transaction : outflows) {
                if (("REINVEST".equals(transaction.getType()) || "DONATE".equals(transaction.getType()) || "GIFT".equals(transaction.getType())) 
                    ...
                    transactionMap.put("project", transaction.getProject() != null ? Map.of("id", transaction.getProject().getId(), "name", transaction.getProject().getName()) : null);
